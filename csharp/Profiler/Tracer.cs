...
public static class Tracer
{
    ...
    private static void EnsureTracingWasNotCorrupted()
    {
        ...
        var corrupted = LastTraceItem.Extent?.Text != null && LastTraceItem.Extent.Text != "$dontRenameThisVariableItIsUsedForCorruptionAutodetection = Set-PsDebug -Trace 0";
        if (corrupted)
        {
    ...
    private static void TraceLine(string message = null, bool justTracer2 = false, bool storeTraceItem = false)
    {
