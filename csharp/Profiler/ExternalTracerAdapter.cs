...
namespace Profiler
{
    class ExternalTracerAdapter : ITracer
    {
        ...
        public ExternalTracerAdapter(object tracer)
        {
            ...
            var traceMethod = tracer.GetType().GetMethod("Trace", new Type[] { typeof(IScriptExtent), typeof(ScriptBlock), typeof(int), typeof(string), typeof(string) });
        ...
        {
            _traceMethod.Invoke(_tracer, new object[] { extent, scriptBlock, level, functionName, moduleName });
        }
    }
}
